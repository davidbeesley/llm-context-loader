...
pub fn create_context_file(
    ...
    writeln!(file, "The following content is a collection of files and directories (Part {} of {}).", file_num, total_files)?;
    writeln!(file, "Each file is clearly marked with a START and END tag.")?;
    writeln!(file, "After reading these files, you will respond with 'Ready' and await further instructions.")?;
...
pub fn get_or_rotate_file(
    ...
    info!("\nCreating new context file {} (token limit of {} reached)", file_num, CLAUDE_TOKEN_LIMIT);
...
pub fn finalize_context_files(
    ...
    for file in context_files {
        ...
        writeln!(output, "Respond only with 'Ready' and await further instructions.")?;
    }
